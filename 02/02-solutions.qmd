...
Gibt es hier keine Ausgabe, dann sind alle Pakete auf dem neuesten Stand. Falls hier doch Pakete aufgelistet werden, kann man diese mit `pip install --upgrade <package>` aktualisieren (statt `<package>` muss man den tatsächlichen Paketnamen angeben).
