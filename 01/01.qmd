...
Unter macOS bzw. Linux öffnen Sie ein Terminal und tippen dort `python` gefolgt von der Eingabetaste. Es kann sein, dass Sie den Befehl `python3` verwenden müssen, um die korrekte Version von Python zu starten – achten Sie auf die vom Interpreter angezeigte Versionsnummer um sicherzustellen, dass die korrekte Python-Version gestartet wurde.
