...
:::{.callout-important}
Listen-Methoden verändern die Liste direkt (in-place) und geben nichts (`None`) zurück. Im Gegensatz dazu können String-Methoden den String nicht verändern und geben daher einen neuen String zurück.
:::
