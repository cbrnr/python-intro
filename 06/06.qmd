...
Für uns relevante mutable Typen sind:

- Liste `list`
- Dictionary `dict`

Für uns relevante immutable Typen sind:
...
Mehr Details zu den Datentypen `list`, `tuple` und `dict` folgen in der nächsten Einheit. Wir widmen uns aber jetzt dem Datentyp String.
...
Im normalen interaktiven Interpreter funktioniert die Tabulator-Taste ebenfalls. Außerdem kann man die Funktion `dir` verwenden, um alle möglichen Methoden eines Objektes aufzulisten, also z.B.
