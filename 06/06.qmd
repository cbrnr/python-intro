...
:::{.callout-note}
Indizieren und Slicen funktionieren bei *allen* Sequenzdatentypen auf dieselbe Weise – also auch bei Strings, die wir in der nächsten Einheit behandeln werden.
:::
...
Mit der bereits im einführenden Beispiel erwähnten Methode `append` kann man neue Elemente am Ende der Liste hinzufügen.
