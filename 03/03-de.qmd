...
Die tatsächlichen Identifikationsnummern sind irrelevant (und wahrscheinlich auf Ihrem Computer unterschiedlich). Es ist nur wichtig, ob zwei Identifikationsnummern identisch sind oder nicht. Im vorherigen Beispiel hat das Objekt `3` eine andere Identifikationsnummer als das Objekt `4`, daher wissen wir, dass dies zwei verschiedene Objekte sind.
