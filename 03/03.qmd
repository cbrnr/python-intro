...
Man sollte Kommazahlen aber ohnehin nie auf Gleichheit überprüfen, da diese aufgrund der begrenzten Genauigkeit nicht exakt repräsentiert werden können (wie bereits in [Einheit 2](../02/02.qmd) besprochen).
