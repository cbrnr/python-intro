...
In Python gibt es eine große Anzahl an Paketen, welche sich auf das Erstellen von Grafiken spezialisiert haben. Eine Übersicht über dieses sehr umfangreiche Ökosystem gibt es [hier](https://rougier.github.io/python-visualization-landscape/), die bekanntesten Pakete sind momentan:
